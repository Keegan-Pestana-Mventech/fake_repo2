...
try:
    ...
    print(f"[{API_NAME}] [OK] numpy {np.__version__} loaded from {np.__file__}")
except ImportError as e:
    print(f"[{API_NAME}] [ERROR] numpy import failed: {e}")
    traceback.print_exc()
except Exception as e:
    print(f"[{API_NAME}] [ERROR] numpy error: {e}")
    traceback.print_exc()
...
try:
    ...
    print(f"[{API_NAME}] [OK] pandas {pd.__version__} loaded from {pd.__file__}")
except ImportError as e:
    print(f"[{API_NAME}] [ERROR] pandas import failed: {e}")
    traceback.print_exc()
except Exception as e:
    print(f"[{API_NAME}] [ERROR] pandas error: {e}")
    traceback.print_exc()
...
async def test():
    ...
    if numpy_available and np:
        try:
            ...
            print(f"[{API_NAME}] [OK] numpy processing successful")
        except Exception as e:
            print(f"[{API_NAME}] [ERROR] numpy processing failed: {e}")
            traceback.print_exc()
            error_details = {
    ...
    # Try pandas processing (if numpy failed or not available)
        ...
        try:
            ...
            print(f"[{API_NAME}] [OK] pandas processing successful")
        except Exception as e:
            print(f"[{API_NAME}] [ERROR] pandas processing failed: {e}")
            traceback.print_exc()
            error_details = {
